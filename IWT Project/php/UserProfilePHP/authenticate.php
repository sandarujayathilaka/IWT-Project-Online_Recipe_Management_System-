...
if ($stmt->num_rows > 0) {
	...
	if ($_POST['password'] == $Password) {
		header('Location: ../../php/UserProfilePHP/profile.php');
...
if ($stmt->num_rows > 0) {
	...
	if ($_POST['password'] == $Password) {
		header('Location: ../../php/UserProfilePHP/admin.php');
...
if ($stmt->num_rows > 0) {
	...
	if ($_POST['password'] == $Password) {
		header('Location: ../../php/UserProfilePHP/nutritionist.php');
...
if ($stmt->num_rows > 0) {
	...
	if ($_POST['password'] == $Password) {
		header('Location: ../../php/UserProfilePHP/home.php');
